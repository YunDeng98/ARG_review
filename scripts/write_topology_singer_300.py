...
def process_file(i):
    ...
    inferred_ts_list = [tskit.load(f'results/singer_ts/singer_300_{i}_{j}.trees') for j in range(50, 100)]
    num_bins = 10000
...
np.savetxt("results/singer_ts/triplet_singer_300.txt", triplet_comparison, fmt='%f', delimiter=',')
np.savetxt("results/singer_ts/quartet_singer_300.txt", quartet_comparison, fmt='%f', delimiter=',')
