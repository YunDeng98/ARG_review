...
np.savetxt("results/tsdate_tsinfer_ts/triplet_tsdate_tsinfer_300.txt", triplet_comparison, fmt='%f', delimiter=',')
np.savetxt("results/tsdate_tsinfer_ts/quartet_tsdate_tsinfer_300.txt", quartet_comparison, fmt='%f', delimiter=',')
