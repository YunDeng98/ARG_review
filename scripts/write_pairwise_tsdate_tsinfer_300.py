...
np.savetxt("results/tsdate_tsinfer_ts/pairwise_tsdate_tsinfer_300.txt", comparison, fmt='%f', delimiter=',')

#plot_hexbin_plot(true_coalescence, inferred_coalescence, 2.5, 5.5, 5e4, "results/figures/pairwise_tsdate_tsinfer_300.png") 
