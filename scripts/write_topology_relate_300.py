...
np.savetxt("results/relate_ts/triplet_relate_300.txt", triplet_comparison, fmt='%f', delimiter=',')
np.savetxt("results/relate_ts/quartet_relate_300.txt", quartet_comparison, fmt='%f', delimiter=',')
