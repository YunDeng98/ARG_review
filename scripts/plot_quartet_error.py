...
comparison_singer_50 = np.loadtxt("results/singer_ts/quartet_singer_50.txt", delimiter=',')
comparison_argweaver_50 = np.loadtxt("results/argweaver_ts/quartet_argweaver_50.txt", delimiter=',')
comparison_relate_50 = np.loadtxt("results/relate_ts/quartet_relate_50.txt", delimiter=',')
comparison_tsdate_tsinfer_50 = np.loadtxt("results/tsdate_tsinfer_ts/quartet_tsdate_tsinfer_50.txt", delimiter=',')
comparison_singer_300 = np.loadtxt("results/singer_ts/quartet_singer_300.txt", delimiter=',')
comparison_arg_needle_300 = np.loadtxt("results/arg_needle_ts/quartet_arg_needle_300.txt", delimiter=',')
comparison_relate_300 = np.loadtxt("results/relate_ts/quartet_relate_300.txt", delimiter=',')
comparison_tsdate_tsinfer_300 = np.loadtxt("results/tsdate_tsinfer_ts/quartet_tsdate_tsinfer_300.txt", delimiter=',')
...
plot_bar_plot(error_50, error_300, methods_50, methods_300, colors_50, colors_300, 0.8, "results/figures/quartet_error.png") 
