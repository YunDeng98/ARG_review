...
def process_file(i):
    ...
    inferred_ts_list = [tskit.load(f'results/argweaver_ts/argweaver_50_{i}.{j}.trees') for j in range(1000, 3000, 40)]
    num_bins = 10000
...
np.savetxt("results/argweaver_ts/triplet_argweaver_50.txt", triplet_comparison, fmt='%f', delimiter=',')
np.savetxt("results/argweaver_ts/quartet_argweaver_50.txt", quartet_comparison, fmt='%f', delimiter=',')
