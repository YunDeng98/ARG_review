...
np.savetxt("results/relate_ts/triplet_relate_50.txt", triplet_comparison, fmt='%f', delimiter=',')
np.savetxt("results/relate_ts/quartet_relate_50.txt", quartet_comparison, fmt='%f', delimiter=',')
