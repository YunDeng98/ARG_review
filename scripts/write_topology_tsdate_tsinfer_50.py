...
np.savetxt("results/tsdate_tsinfer_ts/triplet_tsdate_tsinfer_50.txt", triplet_comparison, fmt='%f', delimiter=',')
np.savetxt("results/tsdate_tsinfer_ts/quartet_tsdate_tsinfer_50.txt", quartet_comparison, fmt='%f', delimiter=',')

#plot_pairwise_heatmap(true_coalescence, inferred_coalescence, 2.5, 5.5, 5e4, "results/figures/pairwise_tsdate_tsinfer_50.png") 
